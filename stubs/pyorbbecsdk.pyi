...
class Config:
    ...
    def disable_stream(self, arg0: OBSensorType) -> None:
        ...
    def enable_accel_stream(self, full_scale_range: OBAccelFullScaleRange = OBAccelFullScaleRange.ACCEL_FS_UNKNOWN, sample_rate: OBGyroSampleRate = OBGyroSampleRate.SAMPLE_RATE_UNKNOWN) -> None:
        ...
    def enable_all_stream(self) -> None:
        ...
    def enable_gyro_stream(self, full_scale_range: OBGyroFullScaleRange = OBGyroFullScaleRange.FS_UNKNOWN, sample_rate: OBGyroSampleRate = OBGyroSampleRate.SAMPLE_RATE_UNKNOWN) -> None:
        ...
    def enable_lidar_stream(self, scan_rate: OBLiDARScanRate = OBLiDARScanRate.LIDAR_SCAN_UNKNOWN, format: OBFormat = OBFormat.UNKNOWN_FORMAT) -> None:
        ...
    @typing.overload
    ...
    def enable_stream(self, arg0: OBSensorType) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, stream_type: OBStreamType, width: typing.SupportsInt | typing.SupportsIndex = 0, height: typing.SupportsInt | typing.SupportsIndex = 0, fps: typing.SupportsInt | typing.SupportsIndex = 0, format: OBFormat = OBFormat.UNKNOWN_FORMAT) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, sensor_type: OBSensorType, width: typing.SupportsInt | typing.SupportsIndex = 0, height: typing.SupportsInt | typing.SupportsIndex = 0, fps: typing.SupportsInt | typing.SupportsIndex = 0, format: OBFormat = OBFormat.UNKNOWN_FORMAT) -> None:
        ...
    @typing.overload
    def enable_video_stream(self, sensor_type: OBSensorType, decimation_config: OBHardwareDecimationConfig, fps: typing.SupportsInt | typing.SupportsIndex = 0, format: OBFormat = OBFormat.UNKNOWN_FORMAT) -> None:
        ...
...
class Context:
    @staticmethod
    def log_external_message(arg0: OBLogLevel, arg1: str, arg2: str, arg3: str, arg4: str, arg5: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @staticmethod
    ...
    def __init__(self, arg0: str) -> None:
        ...
    def create_net_device(self, address: str, port: typing.SupportsInt | typing.SupportsIndex, access_mode: OBDeviceAccessMode = OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS) -> Device:
        """
        Create net device
        """
...
class Device:
    ...
    def trigger_capture(self) -> None:
        ...
    def update_firmware(self, file_path: str, callback: collections.abc.Callable, async_update: bool = True) -> None:
        ...
...
class DeviceList:
    ...
    def get_count(self) -> int:
        ...
    def get_device_by_index(self, index: typing.SupportsInt | typing.SupportsIndex, access_mode: OBDeviceAccessMode = OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS) -> Device:
        ...
    def get_device_by_serial_number(self, serial_number: str, access_mode: OBDeviceAccessMode = OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS) -> Device:
        ...
    def get_device_by_uid(self, uid: str, access_mode: OBDeviceAccessMode = OBDeviceAccessMode.OB_DEVICE_DEFAULT_ACCESS) -> Device:
        ...
...
class OBCalibrationParam:
    ...
    def get_distortion(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> OBCameraDistortion:
        ...
    def get_extrinsic(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> OBExtrinsic:
        ...
    ...
    def set_distortion(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: OBCameraDistortion) -> None:
        ...
    def set_extrinsic(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex, arg2: OBExtrinsic) -> None:
        ...
...
class PresetResolutionConfigList:
    def get_count(self) -> int:
        ...
        """
    def get_preset_resolution_ratio_config(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> OBPresetResolutionConfig:
        """
...
class StreamProfileList:
    ...
    def get_stream_profile_by_index(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> StreamProfile:
        ...
    @typing.overload
    def get_video_stream_profile(self, width: typing.SupportsInt | typing.SupportsIndex = 0, height: typing.SupportsInt | typing.SupportsIndex = 0, format: OBFormat = OBFormat.UNKNOWN_FORMAT, fps: typing.SupportsInt | typing.SupportsIndex = 0) -> VideoStreamProfile:
        ...
    @typing.overload
    def get_video_stream_profile(self, decimation_config: OBHardwareDecimationConfig, format: OBFormat = OBFormat.UNKNOWN_FORMAT, fps: typing.SupportsInt | typing.SupportsIndex = 0) -> VideoStreamProfile:
        ...
...
class ThresholdFilter(Filter):
    ...
    def get_min_range(self) -> OBIntPropertyRange:
        ...
    def set_value_range(self, arg0: typing.SupportsInt | typing.SupportsIndex, arg1: typing.SupportsInt | typing.SupportsIndex) -> bool:
        ...
...
def save_lidar_point_cloud_to_ply(arg0: str, arg1: LiDARPointsFrame, arg2: bool) -> None:
    ...
def save_point_cloud_to_ply(file_name: str, frame: Frame, save_binary: bool = False, use_mesh: bool = False, mesh_threshold: typing.SupportsFloat | typing.SupportsIndex = 50.0) -> None:
    ...
def transformation2dto2d(arg0: OBPoint2f, arg1: typing.SupportsFloat | typing.SupportsIndex, arg2: OBCameraIntrinsic, arg3: OBCameraDistortion, arg4: OBCameraIntrinsic, arg5: OBCameraDistortion, arg6: OBExtrinsic) -> OBPoint2f:
    ...
def transformation2dto3d(arg0: OBPoint2f, arg1: typing.SupportsFloat | typing.SupportsIndex, arg2: OBCameraIntrinsic, arg3: OBExtrinsic) -> OBPoint3f:
    ...
